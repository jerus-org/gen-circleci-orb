...
Summary: Fixed[2], Testing[1]

### Fixed

 - fix: share blank check with optional params
 - fix: harden workspace_sourced blank/leak handling
...
### Added
 ...
 - feat: highlight the file name in update reports
 - feat: give --check argument errors remedy detail
...
### Added
 ...
 - feat: report all update --check problems at once

### Changed

 - refactor: use method reference for to_str

## [0.1.23] - 2026-09-21

Summary: Added[1], Chore[1], Testing[2]
...
### Added
 ...
 - feat: explicit [post_merge_regen].requires config
...
### Fixed
 ...
 - fix: skip validation regen on relocated branches

### Changed

 - refactor: dedupe pack/review pre-steps selection

## [0.1.17] - 2026-09-14

Summary: Chore[1], Documentation[1], Fixed[5]

### Fixed

 - fix: strip comments, drop flow-mapping parsing
 - fix: correct effective-name detection edge cases
 - fix: run relocated chain last, not customer jobs
 - fix: guard requires-wiring against bad YAML
 - fix: wire requires for post-merge-regen push race
...
### Added
 ...
 - feat: post-merge regen for bot PRs (#328)
...
### Fixed
 ...
 - fix: decouple regen from pack/review (#382)

### Changed

 - refactor: trim redundant comment

## [0.1.13] - 2026-09-11

Summary: Added[1], Chore[1], Fixed[4]
...
### Added
 ...
 - feat: toggle-gated live-regenerate validation

### Fixed

 - fix: rename verbose2-4 enum values to vv-vvvv
 - fix: simplify log_level description per review
 - fix: assert clap-verbosity-flag, not hedge it
 - fix: isolate wiring check from the fresh binary
 - fix: explain each log_level enum value's effect

### Changed

 - refactor: split pack_validate_steps helpers

## [0.1.11] - 2026-09-09

Summary: Added[2], Chore[2], Fixed[10]
...
### Fixed
 ...
 - fix(deps): update rust crate pcu to 0.6.33
...
### Fixed
 ...
 - fix: collect cargo_tools errors, trim comments
 - fix: support crate:binary syntax in cargo_tools
...
Summary: Added[2], Changed[11], Chore[2], Documentation[4], Fixed[24], Testing[1]
...
### Fixed
 ...
 - fix: emit unmarked orb pins before managed block

## [0.1.3] - 2026-07-27

Summary: Added[1], Chore[3], Documentation[3], Fixed[4]
