...
- harden workspace_sourced blank/leak handling(pr [#455])
...
- deps: update dependency gen-circleci-orb to v0.1.25(pr [#451])
- deps: update rust crate pcu to 0.6.36(pr [#452])
...
- deps: update rust crate config to 0.15.26(pr [#448])

## [0.1.24] - 2026-09-21

### Added

- report all update --check problems at once(pr [#439])

## [0.1.23] - 2026-09-21

### Added

- validate orb job arguments in all CI files(pr [#438])
...
- key short_param by the effective name(pr [#436])
...
- deps: update dependency gen-circleci-orb to v0.1.16(pr [#393])
- post-merge-regen push race(pr [#394])
...
- deps: update dependency gen-circleci-orb to v0.1.15(pr [#389])
...
- deps: update rust crate uuid to 1.26.1(pr [#377])
...
- log_level enum description + isolate CI wiring check(pr [#365])
...
- deps: update dependency gen-orb-mcp to v0.2.3(pr [#332])
- deps: update dependency toolkit to v7.3.0(pr [#333])
- deps: update rust crate uuid to 1.25.0(pr [#334])
...
- deps: update rust crate indexmap to 2.14.1(pr [#340])
- deps: update rust crate pcu to 0.6.34(pr [#341])
- deps: update rust crate uuid to 1.26.0(pr [#342])
- deps: update dependency toolkit to v7.4.0(pr [#343])
- adapt to circleci-cli 1.0 install and command surface(pr [#345])
...
- deps: lock file maintenance(pr [#327])
...
- Revert "fix(deps): update dependency circleci-public/circleci-cli to v1"(pr [#309])
...
- deps: update dependency toolkit to v7(pr [#231])
- deps: lock file maintenance(pr [#232])
...
[#259]: https://github.com/jerus-org/gen-circleci-orb/pull/259
...
[#332]: https://github.com/jerus-org/gen-circleci-orb/pull/332
[#333]: https://github.com/jerus-org/gen-circleci-orb/pull/333
[#334]: https://github.com/jerus-org/gen-circleci-orb/pull/334
...
[#340]: https://github.com/jerus-org/gen-circleci-orb/pull/340
[#341]: https://github.com/jerus-org/gen-circleci-orb/pull/341
[#342]: https://github.com/jerus-org/gen-circleci-orb/pull/342
[#343]: https://github.com/jerus-org/gen-circleci-orb/pull/343
[#345]: https://github.com/jerus-org/gen-circleci-orb/pull/345
[#351]: https://github.com/jerus-org/gen-circleci-orb/pull/351
[#352]: https://github.com/jerus-org/gen-circleci-orb/pull/352
[#353]: https://github.com/jerus-org/gen-circleci-orb/pull/353
...
[Unreleased]: https://github.com/jerus-org/gen-circleci-orb/compare/v0.1.26...HEAD
